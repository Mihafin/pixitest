define(["pixi", "app_params", "common/utils", "i18n!nls/loader"], function(_, AppParams, Utils, loader_texts){
    ...
    Scene.prototype.init_render = function(){
        ...
        var renderer = PIXI.autoDetectRenderer(AppParams.width, AppParams.height, {backgroundColor: 0xccccff});
